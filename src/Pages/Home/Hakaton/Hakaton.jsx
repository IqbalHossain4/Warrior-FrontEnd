...
const Hakaton = () => {
  ...
  const upcoming = hakatons.filter(
    (hakaton) => hakaton.category === "Upcoming Hackathon"
  );

  const running = hakatons.filter(
    (hakaton) => hakaton.category === "Running Hackathon"
  );
  ...
  return (
    <div className="containers">
      <Tabs defaultIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
        ...
        <TabPanel>
          <h1 className="text-center my-10  text-4xl text-white">
            UpComing Hackatoon
          </h1>
